module TotalPayments
  class MyFirstJob < ActiveJob::Base
    ...
    def step_bases(base_records)
      steps = { '05:00' => 0, '06:00' => 1, '07:00' => 2, '08:00' => 3, '09:00' => 4, '10:00' => 5, '11:00' => 6, '12:00' => 7, '13:00' => 8, '14:00' => 9,
                '15:00' => 10, '16:00' => 11, '17:00' => 12, '18:00' => 13, '19:00' => 14, '20:00' => 15, '21:00' => 16, '22:00' => 17, '23:00' => 18 }
      key = Time.now.in_time_zone("Eastern Time (US & Canada)").beginning_of_hour.strftime('%H:%M')
      current_step = steps[key]
      return 0 if current_step.blank?

      pending = if current_step < 10
                        10.0 - current_step
                      else
                        19.0 - current_step
                      end
